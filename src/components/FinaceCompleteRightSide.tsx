    ...
    <main className="flex w-full h-full">
      ...
      <div className="flex flex-col w-full h-full">
        ...
        <div className="p-5 mx-16 mt-10 rounded-lg flex flex-col justify-center relative items-center bg-[#FAFAFA] min-h-[600px]">
          ...
          <p className="text-xl font-semibold text-[#6A6A6A] mb-10">
            Your Order has been place and an invoice has been sent to your
            Email.
          </p>
          <svg
            width="167"
...
export default FinaceCompleteRightSide;
